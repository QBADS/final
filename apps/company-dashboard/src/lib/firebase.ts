 ...
 * Only used for the real-time dashboard feed (live feed + ticker) - see
 * useLiveFeed/useFirestoreTicker in lib/useApi.ts. Everything else on this
 * dashboard still talks to Middleware's REST API, unchanged.
 */
